...
import static io.github.daanipuui.swing.inflater.calculator.CalculatorTest.PERFORMANCE_TEST_COUNT;
...
public class Calculator extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < PERFORMANCE_TEST_COUNT; i++) {
            ...
            calc.dispatchEvent(new WindowEvent(calc, WindowEvent.WINDOW_CLOSED));
        }

        LOGGER.info("Running calculator [{}] times took [{}] ns. Average = [{}]. Min = [{}]. Max = [{}].", PERFORMANCE_TEST_COUNT, total, total/ PERFORMANCE_TEST_COUNT, min, max);
    }
